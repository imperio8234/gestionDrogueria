         ...
         <div onClick={(e)=>{e.target.className == "modalRegister" &&setEditModal(false)}} className={editModal?"modalRegister":"modalRegister closedModal"}>
                    <div className="formularioProducts">
                        ...
                        <form className="formuR form-control">
                            ...
                            <label htmlFor="costo">
                            costo
                                <input placeholder={ObjProductEdit.costo && ObjProductEdit.costo} onChange={(e)=>setCosto(e.target.value)} className="form-control" name="costo" id="costo" type="text" value={costo} />
                            </label>
                            <label htmlFor="precio">
                                precio de venta
                                <input placeholder={ObjProductEdit.precio && ObjProductEdit.precio} onChange={(e)=>setPrecio(e.target.value)} className="form-control" name="precio" id="precio" type="text"value={precio}/>
                            </label>
